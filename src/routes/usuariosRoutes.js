...
usuariosRouter.get('/:email/moderados', (req, res) => usuariosController.moderados(req, res));
usuariosRouter.get('/:email/speedruns', (req, res) => usuariosController.speedruns(req, res));
...
usuariosRouter.delete('/desmoderar/:email/:jogoId', isAuth, (req, res) => usuariosController.desmoderar(req, res));
