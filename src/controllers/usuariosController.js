...
class UsuariosController {
    ...
    async signIn(req, res) {
        const error = await Util.validate([
            { valor: req.body.email, nome: "email", tipo: "string" },
            { valor: req.body.senha, nome: "senha", tipo: "string" },
    ...
    async moderar(req, res) {
        const error = await Util.validate([
            { valor: req.body.email, nome: "email", tipo: "string" },
            { valor: req.body.jogos, nome: "jogos", tipo: "array" },
        ], "AND")
    ...
    async detalha(req, res) {
        const error = await Util.validate([
            { valor: req.params.email, nome: "email", tipo: "string" },
        ], "AND")
    ...
    async desmoderar(req, res) {
        const error = await Util.validate([
            { valor: req.params.email, nome: "email", tipo: "string" },
            { valor: req.params.jogoId, nome: "jogoId", tipo: "integer" },
        ], "AND")
